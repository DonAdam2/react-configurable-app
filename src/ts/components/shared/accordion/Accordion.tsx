...
//interfaces
import { AccordionInterface } from '../../../interfaces/components/AccordionInterface';

const Accordion: FC<AccordionInterface> = ({ label, accordionIcon, isAccordionOpen, children }) => {
